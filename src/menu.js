const renderMenuPage = (() => ({
  displayMenu() {
    ...
    main.innerHTML = '';
    renderMenuPage.card('./images/picanha.jpg', 'Pincanha Wagyu', 'Top sirloin cap, also known as Brazilian picanha, is an inexpensive and flavorful steak that can be roasted or grilled.', '1000');
